...
use Yii;
use common\models\TblstudentRegistration;
use common\models\TblstudentRegistrationSearch;
use common\models\TblschoolInfo;
use common\models\TblclassDivision;
