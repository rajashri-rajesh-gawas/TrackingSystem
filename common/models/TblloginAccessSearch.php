...
use common\models\TblloginAccess;

/**
 * TblloginAccessSearch represents the model behind the search form about `common\models\TblloginAccess`.
 */
class TblloginAccessSearch extends TblloginAccess
{
    ...
    {
        return [
            [['login_access_id', 's_id', 'emp_id', 'student_id', 'is_deleted'], 'integer'],
