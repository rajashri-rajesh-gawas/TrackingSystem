...
use common\models\TblemployeeAttendance;

/**
 * TblemployeeAttendanceSearch represents the model behind the search form about `common\models\TblemployeeAttendance`.
 */
